...
function goTeacher(){restoreTeacherSession();if(typeof window.show==='function'){window.show('teacher');setTimeout(()=>{if(typeof window.basaCloudRefreshTeacher==='function')window.basaCloudRefreshTeacher();},250);}else{location.href='/Basa-Track/online-app/BASA_TRACK_PRESENTATION_READY.html?teacher=1';}}
...
if(typeof originalShow==='function'){
  window.show=function(id){
    ...
    if(marked&&isTeacher()&&(id==='home'||id==='login')){clearPreview();goTeacher();return;}
...
if(typeof originalLogout==='function'){
  window.logout=function(){
    ...
    if(wasPreview&&isTeacher()){clearPreview();goTeacher();return;}
